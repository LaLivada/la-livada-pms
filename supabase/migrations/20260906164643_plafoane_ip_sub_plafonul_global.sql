...
begin
  ...
  -- Pragurile pe IP stau intre doua cerinte care trag in sensuri opuse.
  --
  -- LARGI, fiindca retelele mobile din Romania pun multi abonati in spatele
  -- aceleiasi adrese: o limita stransa ar opri oameni fara nicio legatura
  -- intre ei.
  --
  -- Dar STRICT SUB PLAFONUL GLOBAL de 25/zi. Cat erau 30/zi, o singura
  -- adresa putea consuma toate rezervarile online ale zilei, iar site-ul
  -- incepea sa raspunda tuturor „Rezervarile online sunt oprite temporar" —
  -- plasa de siguranta se transforma in butonul de oprire al atacatorului.
  --
  -- 12/zi imparte diferenta: e nevoie de cel putin trei adrese ca sa se
  -- ajunga la plafonul global, si e mult peste cate rezervari poate face
  -- intr-o zi un grup de abonati care chiar imparte un IP, la o pensiune cu
  -- sub 25 de rezervari online pe zi in total.
  --
  -- Nimic din toate astea nu inlocuieste Turnstile: fara TURNSTILE_SECRET,
  -- `booking-create` lasa sa treaca orice cerere, iar plafoanele raman
  -- singura aparare.
  ...
  -- 5. OASPETE, recunoscut dupa telefon SI nume.
  --
  -- Cu telefonul singur, cine afla numarul cuiva putea face o rezervare
  -- atasata fisei aceluia, iar pagina cu token ii arata inapoi numele real
  -- al proprietarului numarului — un oracol nume-din-telefon, ieftin de
  -- pornit. In plus, rezervarea murdarea fisa unui client adevarat.
  --
  -- Clientul fidel care isi scrie numele la fel e recunoscut ca inainte.
  -- Cine il scrie altfel primeste o fisa noua, pe care receptia o poate uni
  -- la loc — o dubla in lista supara mult mai putin decat datele unui om
  -- aratate altcuiva.
