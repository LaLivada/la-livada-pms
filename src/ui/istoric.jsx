 ...
 * PMS (15 septembrie 2026). Fiecare Dialog pune o intrare in istoricul
 * browserului la deschidere; popstate inchide fereastra din varful stivei;
 * la inchiderea din buton, intrarea se consuma cu history.back(), ca
 * „inapoi" sa nu ceara doua apasari. Shell (pms-app.jsx) intreaba
 * existaFerestreDeschise() ca sa nu schimbe ecranul cat timp o fereastra a
 * prins evenimentul.
 *
...
export function useFereastraInIstoric(onClose) {
  ...
  useEffect(() => {
    if (typeof history === "undefined" || typeof window === "undefined") return undefined;
