...
| [`oblio-plan.md`](oblio-plan.md) | Planul de implementare al facturării prin Oblio.eu (Oblio dă seria, numărul, PDF-ul și e-Factura; PMS-ul păstrează copia): 8 sarcini cu teste și commit-uri, scris pe 16 septembrie 2026. Implementat pe 16 septembrie 2026. |
