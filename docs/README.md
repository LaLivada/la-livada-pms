...
| [`lynk-samsung.md`](lynk-samsung.md) | Mesajele de bun venit de pe televizoarele din camere, prin Samsung LYNK Cloud: ce se trimite la check-in, ce dispare la check-out, ce e verificat din documentația publică Samsung și ce rămâne de confirmat cu contul de proprietate (contractul Open API). Implementată pe 18 septembrie 2026 (`tv-provider`), pe furnizorul `simulare` până sosesc credențialele. |
